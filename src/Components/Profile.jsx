        ...
        <div className='bg-white relative py-10 rounded-2xl flex flex-col sm:flex-row lg:flex-col items-center justify-center gap-2 font-[Raleway] mb-10 '>
            ...
            <div className='flex flex-col items-center gap-2 justify-center'>
                ...
                <div className='flex gap-3 mt-2'>
                    <div className='p-5 bg-[#F2F7FC] rounded-lg cursor-pointer'><a href="https://www.linkedin.com/in/deepakvaishnav3112/" target="_blank" rel="noopener noreferrer"><img src={assets.linkedin} alt="Linkedin" /></a></div>
                    {/* <div className='p-5 bg-[#F2F7FC] rounded-lg cursor-pointer'><a href="" target="_blank" rel="noopener noreferrer"><img src={assets.twitter} alt="Twitter" /></a></div> */}
                    <div className='p-5 bg-[#F2F7FC] rounded-lg cursor-pointer'><a href="https://github.com/DeepakVaishnav3112" target="_blank" rel="noopener noreferrer"><img src={assets.github} alt="Github" /></a></div>
                </div>
            </div>
            ...
            <div className='flex flex-col gap-3 bg-[#F2F7FC] px-5 py-8 rounded-lg mx-5 mt-5 sm:mt-0 lg:mt-5'>
                ...
                <div className='flex gap-5 border-b pb-5'>
                    ...
                    <div className='flex-grow'>
                        <p className='text-[rgba(26,16,3,0.5)] text-sm font-semibold'>Phone</p>
                        <p className='font-semibold font-[poppins] text-xs overflow-hidden text-ellipsis'>+91 9887236064</p>
                    </div>
                </div>
                ...
                <div className='flex gap-5 border-b pb-5'>
                    ...
                    <div className='flex-grow ml-[-4px]'>
                        <p className='text-[rgba(26,16,3,0.5)] text-sm font-semibold'>Email</p>
                        <p className='font-semibold font-[poppins] text-xs overflow-hidden text-ellipsis'>deepakvaishnav7740@gmail.com</p>
                    </div>
                </div>
                ...
                <div className='flex gap-5 pb-5'>
                    ...
                    <div className='flex-grow'>
                        <p className='text-[rgba(26,16,3,0.5)] text-sm font-semibold'>Location</p>
                        <p className='font-semibold font-[poppins] text-xs overflow-hidden text-ellipsis'>Rajasthan, India</p>
                    </div>
                </div>
